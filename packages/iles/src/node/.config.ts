...
import { AliasOptions, UserConfig as ViteConfig, mergeConfig as mergeViteConfig } from 'vite'
import { Options as VuePluginOptions } from '@vitejs/plugin-vue'
import { PluginOptions as MarkdownOptions } from 'vite-plugin-xdm'
import { IslandsConfig } from './shared'
...
export interface UserConfig extends Partial<IslandsConfig> {
