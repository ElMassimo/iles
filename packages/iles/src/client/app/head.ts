...
export function defaultHead(
  { frontmatter, meta, route, config, site }: AppContext,
  includeSocialTags: boolean | undefined,
): HeadConfig {
  ...
  return {
    title,
    meta: metaTags,
    link: [config.sitemap && { rel: 'sitemap', href: `${site.url}/sitemap.xml` }].filter(notEmpty),
