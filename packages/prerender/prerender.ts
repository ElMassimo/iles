...
const _imports: {
  preact?: [typeof import("@islands/hydration/preact"), typeof import("preact-render-to-string")]
  solid?: typeof import("solid-js/web")
} = {}

export const renderers: Record<Framework, PrerenderFn> = {
  async preact(component, props, slots) {
    const [{ createElement }, { renderToString }] = (_imports.preact ||= await Promise.all([
  ...
  async solid(component, props, slots, renderId) {
    const { ssr, renderToString, createComponent } = (_imports.solid ||=
