...
audio: /audio/meditacion-de-la-tangerina.mp3
---
...
<Quote author="Bret Victor" client:idle>
  Creators need an __*immediate*__ connection to what they're creating.
</Quote>

```
<script type="module">Amazing!</script>
```
