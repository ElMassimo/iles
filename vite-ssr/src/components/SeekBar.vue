...
const totalDuration = $computed(() => formatSecondsAsMinutes(props.duration))

let draggingTime = $ref<number | undefined>()
const isDragging = $computed(() => draggingTime !== undefined)
const seekingTime = $computed(() => isDragging ? draggingTime : props.currentTime)
const fractionElapsed = $computed(() =>
...
useResizeObserver($raw(seekBar), (entries) => {
