...
Use <kbd>markdown.extendFrontmatter</kbd> to provide additional frontmatter options,
like setting a different layout for all pages in a specific dir, or inferring the title or date from the file name.
</Tip>
