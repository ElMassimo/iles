...
Enabled by default, provides excellent MDX support and allows to tap into the
[remark] and [rehype] ecosystems.
...
<Tip>
You may add additional properties in the frontmatter by using the <kbd>markdown.extendFrontmatter</kbd> option.
</Tip>
