...
It combines techniques from [`quicklink`][quicklink] and [`@hotwired/turbo`][hotwired], but taking advantage of the architecture of every <Iles/> site to achieve it in **under 2kb**.
