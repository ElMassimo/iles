...
<Tip title="Only String Literals" warn>
  Just like [glob imports][glob] in Vite.js, you need to provide a string pattern directly,
  variables are not supported as it wouldn't be possible to perform static analysis and infer which
  files to build.
</Tip>
