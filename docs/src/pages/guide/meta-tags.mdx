...
<Iles /> will use [site] data such as `title` and `description` and combine them with page
titles—specified in [frontmatter]—to set reasonable default values for commonly used meta tags.
