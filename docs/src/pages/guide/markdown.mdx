...
[components]: /guide/frameworks
[enhanceApp]: /config#enhanceapp

# Markdown 📖

<Iles/> provides excellent support for [`.mdx`][mdx] files thanks to <kbd>[xdm]</kbd>, allowing you to use [components] inside markdown, and use markdown components in Vue.
...
<Iles/> extends [XDM] enabling you to use [components] in MDX files.
