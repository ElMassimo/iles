...
This technique can also be used more broadly. For example, to override components only in MDX pages using a specific layout:
...
<template>
  <main>
    <slot :components="postComponents"/>
  </main>
</template>
```
