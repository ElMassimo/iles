...
To get started, create a Vue page and use the [`<page>` block][pages] to specify
a <kbd>[path][routing]</kbd> for the feed.
...
[Glob imports] are a convenient way to access multiple files or pages to generate feed items.
