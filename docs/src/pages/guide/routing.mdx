...
<Tip title="Fetching Data from APIs">
Use <kbd>[getStaticPaths]</kbd> to generate pages for data fetched
from an API or a CMS.

[See this full example][directus] for a blog that [obtains articles] from an API.
</Tip>
